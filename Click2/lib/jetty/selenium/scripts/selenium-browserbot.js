...
BrowserBot.prototype.hasPrintDialogs = function() {
	return (this.recordedPrintDialogs.length > 0);
}
...
BrowserBot.prototype.modifyWindowToRecordPopUpDialogs = function(windowToModify, browserBot) {
    ...
    windowToModify.print = function(message) {
        browserBot.recordedPrintDialogs.push(true);
    }
...
BrowserBot.prototype.getReadyState = function(windowObject, currentDocument) {
    ...
    if (rs == null) {
        if (this.buttonWindow && this.buttonWindow.document.readyState == null) {

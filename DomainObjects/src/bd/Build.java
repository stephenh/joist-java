...
public class Build {
    ...
    public Jar binaryJar = new Jar("bin/exigence-domainobjects.jar").includes(this.binMain);
    public Zip sourceZip = new Zip("bin/exigence-domainobjects.zip").includes(this.srcMain.getSourceFiles().get(0));

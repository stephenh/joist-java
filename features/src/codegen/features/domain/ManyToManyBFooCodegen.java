...
public abstract class ManyToManyBFooCodegen extends AbstractDomainObject {
    ...
    public void setBlueManyToManyBFooToBars(List<ManyToManyBFooToBar> blueManyToManyBFooToBars) {
        for (ManyToManyBFooToBar o : joist.util.Copy.shallow(this.getBlueManyToManyBFooToBars())) {
    ...
    public void setGreens(List<ManyToManyBBar> greens) {
        for (ManyToManyBBar o : Copy.shallow(this.getGreens())) {
            this.removeGreen(o);
        }
    ...
    static class Shims {
        protected static final Shim<ManyToManyBFoo, Integer> id = new Shim<ManyToManyBFoo, Integer>() {
        ...
        protected static final Shim<ManyToManyBFoo, Integer> version = new Shim<ManyToManyBFoo, Integer>() {

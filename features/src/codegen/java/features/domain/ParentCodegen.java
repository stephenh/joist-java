...
public abstract class ParentCodegen extends AbstractDomainObject {
  ...
  private final ForeignKeyListHolder<Parent, Primitives> primitivess = new ForeignKeyListHolder<Parent, Primitives>((Parent) this, Aliases.primitives(), Aliases.primitives().parent, new PrimitivessListDelegate());
  ...
  public List<Primitives> getPrimitivess() {
    return this.primitivess.get();
  }

  public void setPrimitivess(List<Primitives> primitivess) {
    ListDiff<Primitives> diff = ListDiff.of(this.getPrimitivess(), primitivess);
    for (Primitives o : diff.removed) {
      this.removePrimitives(o);
    }
    for (Primitives o : diff.added) {
      this.addPrimitives(o);
    }
    this.primitivess.set(primitivess);
  }

  public void addPrimitives(Primitives o) {
    if (o.getParent() == this) {
      return;
    }
    o.setParentWithoutPercolation((Parent) this);
    this.addPrimitivesWithoutPercolation(o);
  }

  public void removePrimitives(Primitives o) {
    if (o.getParent() != this) {
      return;
    }
    o.setParentWithoutPercolation(null);
    this.removePrimitivesWithoutPercolation(o);
  }

  protected void addPrimitivesWithoutPercolation(Primitives o) {
    this.getChanged().record("primitivess");
    this.primitivess.add(o);
  }

  protected void removePrimitivesWithoutPercolation(Primitives o) {
    this.getChanged().record("primitivess");
    this.primitivess.remove(o);
  }
  ...
  public void clearAssociations() {
    ...
    for (Primitives o : Copy.list(this.getPrimitivess())) {
      removePrimitives(o);
    }
  }
  ...
  private class PrimitivessListDelegate implements ListProxy.Delegate<Primitives> {
    public void doAdd(Primitives e) {
      addPrimitives(e);
    }
    public void doRemove(Primitives e) {
      removePrimitives(e);
    }
  }
  ...
  public static class ParentChanged extends AbstractChanged {
    ...
    public boolean hasPrimitivess() {
      return this.contains("primitivess");
    }
  }

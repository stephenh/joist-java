...
public class HistoryEntryTest extends AbstractFeaturesTest {
  ...
  public void testInsert() {
    ...
    assertEntry(1, "insert", 1, "primitives", null, null, null);
  }
  ...
  public void testUpdate() {
    ...
    assertEntry(2, "update", 1, "primitives", "flag", "true", "false");
    assertEntry(3, "update", 1, "primitives", "name", "n1", "n2");
  }
  ...
  public void testDelete() {
    ...
    assertEntry(2, "delete", 1, "primitives", null, null, null);
  }
  ...
  public void testInsertWithInheritance() {
    ...
    assertEntry(1, "insert", 1, "inheritance_a_base", null, null, null);
  }
  ...
  public void testUpdateWithInheritance() {
    ...
    assertEntry(2, "update", 1, "inheritance_a_base", "one", "ss1", "ss2");
    assertEntry(3, "update", 1, "inheritance_a_base", "name", "s1", "s2");
  }
  ...
  public void testDeleteWithInheritance() {
    ...
    assertEntry(2, "delete", 1, "inheritance_a_base", null, null, null);
  }
  ...
  private static void assertEntry(int id, String type, int primaryKey, String rootTableName, String propertyName, String oldValue, String newValue) {
    ...
    assertThat(e.getUpdater(), is("testing"));
  }
